...
$string['categorycourselist'] = 'Category/Course list';
$string['coursefilesize'] = 'Course file size';
...
$string['uploadpdf_help'] = 'Upload PDF file';
$string['uploadpdffile_help'] = 'Upload PDF file';
